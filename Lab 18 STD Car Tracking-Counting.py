...
capture = cv.VideoCapture('CarsDriving.mp4')
...
while True:
    ...
    FocusArea = [300,100,750,550] # บริเวณที่แสดง Blob
    ...
    cv.rectangle(frame, (xFA,yFA), (xFA+wFA,yFA+hFA), (255,100,100)), cv.rectangle(contours_img, (xFA,yFA), (xFA+wFA,yFA+hFA), (255,100,100))
    ...
    cv.line(frame,(0,y_startCount),(fWidth,y_startCount),(0,255,0),2),    cv.line(frame,(0,y_endCount),(fWidth,y_endCount),(0,255,0),2)
    cv.line(contours_img,(0,y_startCount),(fWidth,y_startCount),(0,255,0),2),    cv.line(contours_img,(0,y_endCount),(fWidth,y_endCount),(0,255,0),2)
    ...
    if(id_frame>100):
        ...
        cv.putText(frame, 'Counter : '+str(blobCount), (300, 35), cv.FONT_HERSHEY_SIMPLEX, 1.2 , (128,128,255),2),cv.putText(contours_img, 'Counter : '+str(blobCount), (500, 30), cv.FONT_HERSHEY_SIMPLEX, 1 , (128,128,255))    

    cv.namedWindow("Frame", cv.WINDOW_NORMAL)
    cv.namedWindow("FG_Mask", cv.WINDOW_NORMAL)
